...
public class GeoUtils {
    ...
    /**
     * Maps a location specified by latitude and longitude values to a cell of a grid covering the area of NYC. The grid
     * cells are roughly 100 x 100 m and sequentially number from north-west to south-east starting by zero.
     *
    ...
    /**
     * Maps the direct path between two locations specified by longitude and latitude to a list of cells of a grid
     * covering the area of NYC. The grid cells are roughly 100 x 100 m and sequentially number from north-west to
    ...
    /**
     * Returns the angle in degrees between the vector from the start to the destination and the x-axis on which the
     * start is located.
     *
